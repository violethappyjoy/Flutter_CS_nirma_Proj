...
Future<List<dynamic>> compList() async {
  final response = await http.post(Uri.parse(API.getCtodo), body: {'uid': uid});
...
class CompTodoList extends StatefulWidget {
  @override
  _CompTodoListState createState() => _CompTodoListState();
}

class _CompTodoListState extends State<CompTodoList> {
